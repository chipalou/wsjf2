...
document.getElementById('save').addEventListener('click', function(){
  ...
  .then(function(){
    ...
    if (ubvSelector.value=="4") {
      ...
      if (tcSelector.value=="1") {
      var tctemp= 1
    } 
    if (tcSelector.value=="2") {
      var tctemp = 2
    } 
     if (tcSelector.value=="3") {
      var tctemp= 3
    } 
    if (tcSelector.value=="4") {
      var tctemp= 5
    } 
      if (tcSelector.value=="5") {
      var tctemp= 8
    } 
      if (tcSelector.value=="6") {
      var tctemp= 13
    } 
      if (tcSelector.value=="7") {
      var tctemp= 21
    } 
    if (rroeSelector.value=="1") {
      var tctemp= 1
    } 
    if (rroeSelector.value=="2") {
      var tctemp = 2
    } 
     if (rroeSelector.value=="3") {
      var tctemp= 3
    } 
    if (rroeSelector.value=="4") {
      var tctemp= 5
    } 
      if (rroeSelector.value=="5") {
      var tctemp= 8
    } 
      if (rroeSelector.value=="6") {
      var tctemp= 13
    } 
      if (rroeSelector.value=="7") {
      var tctemp= 21
    } 
    if (jsSelector.value=="1") {
      var tctemp= 1
    } 
    if (jsSelector.value=="2") {
      var tctemp = 2
    } 
    if (jsSelector.value=="3") {
      var tctemp= 3
    } 
    if (jsSelector.value=="4") {
      var tctemp= 5
    } 
    if (jsSelector.value=="5") {
      var tctemp= 8
    } 
    if (jsSelector.value=="6") {
      var tctemp= 13
    } 
    if (jsSelector.value=="7") {
      var tctemp= 21
    } 
    
    var wsjfval = (ubvtemp+tctemp+rroetemp)
